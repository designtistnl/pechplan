                ...
                <div class="fade-in">
                    ...
                    <div class="space-y-6">
                        <div class="flex items-center gap-4">
                            ...
                            <div><div class="text-white/40 text-sm">Telefoon</div><a href="tel:0882474700" class="text-white font-semibold hover:text-pech-orange transition-colors">088 247 47 00</a></div>
                        </div>
                        <div class="flex items-center gap-4">
                            <div class="w-12 h-12 rounded-xl bg-white/5 flex items-center justify-center flex-shrink-0">
